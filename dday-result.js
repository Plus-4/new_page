...
var firstDay = new Date("2023-03-02");  // 처음 만난 날의 날짜 정보를 firstDay 객체로 만듭니다. 
...
calcDate(365);  // 200일 기념일을 계산해서 표시합니다.
calcDate(730);  // 1년 기념일을 계산해서 표시합니다.
calcDate(1000);  // 500일 기념일을 계산해서 표시합니다.
calcDate(1825);
calcDate(3650);
